...
function filtreTableau() {
    // Si on recherche rien on retourne tout le tableau
...
// Fonction qui créer un tableau HTML à partir du tableau des personnes
...
// Ecouter le changement de valeur du champ
txtRechercher.addEventListener('input', function () {
    construireTableau();
    console.log(txtRechercher.value);
});

// Ecoute à la fin du chargement de la page
